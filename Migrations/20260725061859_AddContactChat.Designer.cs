...
namespace Fruitables.Migrations
{
    ...
    [Migration("20260725061859_AddContactChat")]
    partial class AddContactChat
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fruitables.Models.ChatConversation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Fruitables.Models.ChatMessage", b =>
                {
                    b.HasOne("Fruitables.Models.ChatConversation", "Conversation")
                        .WithMany("Messages")
                        .HasForeignKey("ConversationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Fruitables.Models.User", "SenderUser")
                        .WithMany()
